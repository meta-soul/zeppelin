 ...
 */
public class CasairService extends OAuth20Service {
    private static  final Logger LOGGER = LoggerFactory.getLogger(CasairService.class);
    public CasairService(DefaultApi20 api, String apiKey, String apiSecret, String callback, String defaultScope, String responseType, OutputStream debugStream, String userAgent, HttpClientConfig httpClientConfig, HttpClient httpClient) {
